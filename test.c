...
#include "stat.h"
#include "user.h"
// Created by hbach on 10/11/2022.


//replace test.c with the test file from lab 1 slides
...
int exitWait(void) {
    ...
    for (i = 0; i < 2; i++) {
        ...
        if (pid == 0) { // only the child executed this code
            ...
            ret_pid = wait(&exit_status); //&exit_status returns the memory address of exit_status variable
